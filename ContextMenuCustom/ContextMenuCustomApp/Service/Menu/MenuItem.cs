...
namespace ContextMenuCustomApp.Service.Menu
{
    public class MenuItem : BaseModel
    {
        ...
        private bool _acceptMultiFiles;
        ...
        public bool AcceptMultiFiles { get => _acceptMultiFiles; set => SetProperty(ref _acceptMultiFiles, value); }
        ...
        public static MenuItem ReadFromJson(string content)
        {
            ...
            return new MenuItem
            {
                ...
                AcceptMultiFiles = json.GetNamedBoolean("acceptMultiFiles", false),
            };
        }
        ...
        public static string WriteToJson(MenuItem content)
        {
            var json = new JsonObject
            {
                ...
                ["acceptMultiFiles"] = JsonValue.CreateBooleanValue(content.AcceptMultiFiles),
            };
